...
public class RepairBackup {
	...
	public RepairBackup(Subject subject, AbstractFaultlocalization fLocalization) {
...
*/
	...
	//			Set<String> already = new HashSet<>();
				 ...
				 */
				w.write("----------buggy block------------\n");
				w.write("FilePath: " + file + "\nLineRang:" + oneBuggyBlock.getLineRangeInSource() + "\n");
				w.write(currentBlockString + "\n");
				w.flush();
				/*
				 * GZ finish this change
				 */
				...
				for(Pair<CodeBlock, Double> similar : candidates){
					 ...
					 * date: 2018/11/11
					 */
					CodeBlock candi = similar.getFirst();
					w.write("----------candidate " + (i++) + " Sim: " + similar.getSecond() +"------------\n");
					w.write("FilePath: " + candi.getFileName() + "\nLineRang:" + candi.getLineRangeInSource() + "\n");
					w.write(candi.toSrcString().toString() + "\n");
					w.flush();
					/*
					 * GZ finish this change
					 */
